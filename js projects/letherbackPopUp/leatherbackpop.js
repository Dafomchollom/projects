class LeatherbackPopUp {
  ...
  generatePaymentPopUp() {
    ...
    leatherBackIframeWrapper.style.background = "rgba(0,0,0,0.5)";
    ...
    leatherBackIframe.style.background = "#ffffff";
    ...
    leatherBackIframe.setAttribute(
      "src",
      `https://app-aaaspaymentlink-dev.azurewebsites.net/popup/` + encodedData
    );
